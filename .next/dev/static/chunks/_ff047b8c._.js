...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            console.error(error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(error.message || "Failed to login. Please check your credentials.");
        } finally{
            setIsLoading(false);
        }
    };
...
_s(LoginPage, "1Pr4NR4QlMrVyY8SPN1eBaKNUio=", false, function() {
    return [
