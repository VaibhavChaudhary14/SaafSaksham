...
if (("TURBOPACK compile-time value", "development") === 'development' && ("TURBOPACK compile-time value", "undefined") !== 'undefined') {
 ...
 */ async function syncUserWithSupabase(firebaseUser) {
    try {
        ...
        const { data: existingProfile } = await supabase.from("profiles").select("id").eq("id", firebaseUser.uid).single();
        if (!existingProfile) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b57d4198._.js.map