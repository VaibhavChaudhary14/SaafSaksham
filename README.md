...
### Installation
 ...
 > [!TIP]
 > See [Development Guide](docs/DEVELOPMENT.md) for detailed step-by-step instructions on running the backend and frontend in sync.

```bash
git clone https://github.com/VaibhavChaudhary14/SaafSaksham.git
cd SaafSaksham
```
